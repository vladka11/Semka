...
//implementacia pomocou zretazeneho zoznamu (linked list)
//pri pouziti jednostranne zretazeneho zoznamu odoberam zo zaciatku a pridavam na koniec, pri obojstrannom je to jedno
...
namespace structures
{
	...
	{
		return list_->size();   //size_ nemoze byt, pristupujem k privatnemu atributu; size nemoze byt, pristupujem k adrese funkcie v pamati
	}
