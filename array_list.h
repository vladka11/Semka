...
namespace structures
{
	...
	inline ArrayList<T>::ArrayList(const ArrayList<T>& other) :
		List(), //arraylist je potomkom listu preto treba najskÙr zavolaù konötruktor 
	...
	template<typename T>
	inline ArrayList<T>::ArrayListIterator::~ArrayListIterator() //vöetky oper·cie iter·tora maj˙ zloûitosù O(1)
	{
		arrayList_ = nullptr;
		position_ = -1;
	}
