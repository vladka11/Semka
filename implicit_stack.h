...
//implementacia zasobnika pomocou array/arraylist
//pridavam prvky, a tiez odoberam z konca arraylistu
...
namespace structures
{
	...
	template<typename T>
	ImplicitStack<T>::ImplicitStack(const ImplicitStack<T>& other) :   //copy konstruktor
		ImplicitStack()  //vytvorenie prazneho zasobnika
	{
		*this = other;  //operator priradenia
	}
	...
	{
		*list_ = *other.list_;  //ak by tam nebol smernik, tak len zmenim ukazovatel list_ z this na other, chcem skopirovat obsah z listu other do listu this, preto dereferencujem
		return *this;
	}
	...
	{
		return list_->removeAt(static_cast<int>(size()) - 1);   // ak size_ = 0, tak arraylist vyhodi vynimku, tu uz nemusim nic osetrit
	}
